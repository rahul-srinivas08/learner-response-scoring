...
**Recommendation: ship Part 2's XGBoost.** XGB+LinReg ensemble scores higher (QWK 0.542, best in the project) but isn't the default — two models to maintain for a 0.01–0.02 gain; documented as the pick if squeezing QWK matters more than simplicity or preffered to XGboost model tree based.
